(function () {
    function initGridEffect() {
        const wrapper = document.querySelector('.about-programs .effect-container');
        const wrapperGrid = document.querySelector('.about-programs .effect-container .grid-effect');
